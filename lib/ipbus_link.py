...
class IPbusLink:
    def __init__(self):
        self.device_ip = "192.168.2.19"
        # self.device_uri = "chtcp-2.0://localhost:10203?target=192.168.3.18:5000>1"
        # < connection id = "Twominus.udp.0" uri = "chtcp-2.0://localhost:10203?target=127.0.0.1:50001" address_table = "file://address.xml" / >
    ...
    def get_hw(self):
        ...
        uhal.disableLogging()
        hw = uhal.getDevice("TwoMinus.udp.0", self.device_uri, self.address_table_uri)
        return hw
